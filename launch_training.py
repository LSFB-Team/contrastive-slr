...
from cslr.modules.heads import ProjectionHead
from cslr.trainers.contrastive import ContrastiveModule
...
def train_contrastive_model(dataloaders, config: ExperimentConfig):
    ...
    print("Training finished. Loading best checkpoint and computing all final embeddings...")
    trainer.test(
        module,
