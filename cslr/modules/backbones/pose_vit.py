...
from cslr.modules.blocks.positional_encoding import PositionalEncoding
...
if __name__ == "__main__":
    N, C_in, C_out, L = 3, 320, 512, 256
    n_heads, n_layers = 4, 4
    encoder = PoseViT(C_in, L, C_out, n_heads, n_layers)
    example_x = torch.randn(N, L, C_in)
    example_mask = torch.ones(N, L)
